...
file_name = f"NSS20 INSIGHT TEAM RAG"

rag.RagReport(source=responses.df, questions=questions,
              ...
              report_name='NHS Staff Survey 2020 - Insight RAG', file_name=file_name,
