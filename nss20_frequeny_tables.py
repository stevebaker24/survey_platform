...
responses = sp.Responses(
    r"C:\Users\steve.baker\PycharmProjects\python-scripts\NSS20_Picker_Reporting_20201207_V4.parquet",
    indexcol='Sample ID')
...
for trust_code in responses.df['Organisation code'].unique():
    ...
    ft.FrequencyTableReport(source=trustdf, questions=questions,
                            sheet_breakdown_fields=['LOCALITY1'], suppression_threshold=11,
                            output_path=r"C:\Users\steve.baker\Desktop\NSS\freq_draft", survey_name=survey_name,
                            report_name='NHS Staff Survey 2020 - Frequency Table Report', file_name=file_name, overall_text='Organisation Overall')
